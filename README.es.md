...
[简体中文](./README.zh-CN.md) | [繁體中文](./README.zh-TW.md) | [English](./README.md#english-documentation) | [Español](./README.es.md) | [Français](./README.fr.md) | [日本語](./README.ja.md) | [한국어](./README.ko.md) | [Русский](./README.ru.md) | [العربية](./README.ar.md)
...
**Weave Epub Reader** es un complemento de lectura de la **serie de complementos Obsidian Weave**, creado por completo para Obsidian y disponible en todas las plataformas de Obsidian. Admite de forma gratuita la lectura de EPUB, TXT, FB2/FBZ, MOBI, AZW3, CBZ, PDF y más, además de notas de extracto con varios estilos de anotación. Los extractos pueden guardarse en archivos **Markdown**, **Canvas** y **mazos Weave**, con enlaces de origen para saltar entre notas y el libro, y los datos permanecen completamente locales.

La experiencia esencial cubre la lectura diaria, la gestión de la estantería, los resúmenes de extractos, las **plantillas de página de datos del libro** y el renderizado en el cuerpo. El soporte Premium añade **líneas de tiempo de extractos de toda la estantería**, **trazado bidireccional**, **lectura por párrafos / pantalla completa inmersiva**, **marcado y estudio de vocabulario** y más—usando herramientas dentro de Obsidian para pensar, afilar el criterio y dar sentido a la lectura.
...
|-----------|:--------------------:|:---------------:|
| **Todas las plataformas** (escritorio / móvil) | ✅ | ✅ |
| Lectura de **EPUB / TXT / FB2 / FBZ / MOBI / AZW3 / CBZ / PDF** | ✅ | ✅ |
| **Mi estantería**: importar, portadas, progreso, búsqueda/filtro, estado de lectura | ✅ | ✅ |
| **Varias vistas** de la estantería, **estadísticas de extractos** (extractos / ideas / tarjetas) | ✅ | ✅ |
| **Salto de índice**, **lectura a doble página**, **desplazamiento continuo de una página** y otros modos | ✅ | ✅ |
| **Tipografía de lectura**: seguir Obsidian, **fuente y tamaño de cuerpo personalizados**, estilos del editor | ✅ | ✅ |
| **Progreso de lectura** persistente, progreso en la estantería | ✅ | ✅ |
...
| **Cinco colores de resaltado**, ideas (`---div---`), extractos y **renderizado en el cuerpo** | ✅ | ✅ |
| Estilos de **subrayado / tachado / subrayado ondulado** | ✅ | ✅ |
| **Extracto automático** (insertar en notas / copiar al portapapeles) | ✅ | ✅ |
...
| **Línea de tiempo** de extractos (**libro actual**, navegar por día) | ✅ | ✅ |
| **Selección por lotes** de extractos, exportar, eliminar | ✅ | ✅ |
| Vinculación **Canvas** y creación automática de nodos | ✅ | ✅ |
| **Plantillas de página de datos del libro** (personalizar el diseño `data_*.md` de cada libro) | ✅ | ✅ |
| **Plantillas de exportación de notas** y presets integrados | ✅ | ✅ |
| Exportar el **cuerpo del capítulo actual** a Markdown | ✅ | ✅ |
| **API pública** (capítulo actual / cuerpo de sección TOC, notas de extracto del capítulo o de todo el libro, etc.) | ✅ | ✅ |
| Interfaz multilingüe (chino simplificado, chino tradicional, English, japonés, coreano, ruso, alemán, español, árabe) y **tutorial** en la app | ✅ | ✅ |
| **Línea de tiempo de extractos de toda la estantería** (revisión diaria entre libros, saltar a la fuente) | 🔒 | ✅ |
| **Barra de densidad del mapa del libro** en la barra lateral del TOC | 🔒 | ✅ |
| **Marcas de capítulo** en el índice (importante / duda / dominado, etc.) | 🔒 | ✅ |
| **Listas de reproducción** de la estantería (incluido establecer como inicio) | 🔒 | ✅ |
...
| **Marcado de vocabulario** (marcas en el texto, consulta con doble clic, añadir al vocabulario Weave) | 🔒 | ✅ |
| **Exportación avanzada a Markdown** (notas de extracto de todo el libro / del capítulo, capítulos con marcas de extracto) | 🔒 | ✅ |
...
Activa en los ajustes del lector. Condiciones: [PREMIUM_TERMS.md](./PREMIUM_TERMS.md).
...
4. Menú del lector → **Ayuda** → **Tutorial** para la guía breve en la app; la pregunta frecuente 1 detalla el flujo de extractos.
...
- Si usas el menú de IA a través del complemento principal **Weave**, se llaman a los servicios de terceros que configures; **el lector en sí no ofrece funciones de IA** (consulta la pregunta frecuente 3).

## Preguntas frecuentes

### 1. ¿Cómo capturo correctamente los extractos de lectura?
...
### 3. ¿El lector integra IA?

En esta etapa, no tenemos previsto integrar IA en el complemento lector. La visión es ofrecerte un entorno de lectura limpio e inmersivo en Obsidian, con una interacción fluida y natural y una edición de texto cómoda. No pretendemos usar IA para análisis automático, resúmenes o lectura asistida conversacional. En la mayoría de los casos, eso interrumpiría tu ritmo de lectura, dispersaría tu atención y dificultaría el pensamiento profundo mientras lees.

Si necesitas IA, puedes copiar contenido, exportar el capítulo actual como archivo MD o usar la **API** del complemento para obtener el texto del capítulo y las notas de extracto, y combinarlo con otros complementos con capacidades de IA para los flujos automatizados que quieras. La API existe exactamente para eso.

### 4. ¿Pueden sincronizarse extractos y notas entre plataformas?
...
### 6. ¿Por qué el soporte Premium es de pago?

El soporte Premium **financia el desarrollo continuo** para que el lector y el flujo de extractos sigan mejorando. La **experiencia esencial es gratuita**—la lectura diaria, cinco colores de resaltado, ideas, extractos y renderizado en el cuerpo son plenamente utilizables sin pagar. Activa el soporte Premium solo cuando quieras la línea de tiempo de extractos de toda la estantería, el trazado bidireccional, el modo de lectura por párrafos y otras capacidades avanzadas.

### 7. ¿Suscripción o compra única?
...
### 8. ¿Cómo cambio la fuente y el tamaño?
...
### 9. ¿Cómo cambio el color de fondo?

El fondo del lector **sigue el tema activo de Obsidian**. Instala y cambia de tema; el complemento no define un fondo propio.
